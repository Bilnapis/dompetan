  ...
  if (success) {
    return (
      <div className="min-h-dvh bg-dark-900 flex flex-col items-center justify-center px-6">
        ...
        <h2 className="text-xl font-bold text-dark-100 mb-2">Cek Email Anda!</h2>
        <p className="text-dark-400 text-sm text-center max-w-xs mb-6">
          Kami telah mengirim link verifikasi ke <strong className="text-dark-200">{email}</strong>. Silakan cek inbox Anda.
        </p>
        <Link to="/login">
