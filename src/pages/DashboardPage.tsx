      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 mb-6">
        ...
        <div className="glass rounded-2xl p-5 relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-2">
            <p
              className={`text-2xl font-bold ${summary.balance >= 0 ? "text-primary-400" : "text-expense"} ${shake ? "animate-shake" : ""}`}
            >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-1 gap-3 lg:contents">
          <div className="glass rounded-2xl p-4">
            ...
            <p
              className={`text-lg font-bold text-income ${shake ? "animate-shake" : ""}`}
            >
              {showNominal
          ...
          <div className="glass rounded-2xl p-4">
            ...
            <p
              className={`text-lg font-bold text-expense ${shake ? "animate-shake" : ""}`}
            >
              {showNominal
