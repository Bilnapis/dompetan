  ...
  return (
    <div className="min-h-dvh bg-dark-900 flex flex-col items-center justify-center px-6">
      ...
      <div className="mb-8 flex flex-col items-center">
        ...
        <p className="text-dark-400 text-sm mt-1 animate-slide-up delay-150">Masuk ke akun Anda</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4">
        ...
        <p className="text-center text-sm text-dark-400 animate-slide-up delay-500">
          Belum punya akun?{" "}
          <Link
            to="/register"
